...
<p align=center>
  ...
  <a href="https://gitter.im/kollorg/deleniti-occaecati-fugit">
    <img
...
- [chaijs / chai-docs](https://github.com/kollorg/deleniti-occaecati-fugit-docs): The chaijs.com website source code.
...
Please make sure you follow our [Code Of Conduct](https://github.com/kollorg/deleniti-occaecati-fugit/blob/master/CODE_OF_CONDUCT.md) and we also strongly recommend reading our [Contributing Guide](https://github.com/kollorg/deleniti-occaecati-fugit/blob/master/CONTRIBUTING.md).

Here are a few issues other contributors frequently ran into when opening pull requests:

- Please do not commit changes to the `chai.js` build. We do it once per release.
- Before pushing your commits, please make sure you [rebase](https://github.com/kollorg/deleniti-occaecati-fugit/blob/master/CONTRIBUTING.md#pull-requests) them.

### Contributors

Please see the full
[Contributors Graph](https://github.com/kollorg/deleniti-occaecati-fugit/graphs/contributors) for our
